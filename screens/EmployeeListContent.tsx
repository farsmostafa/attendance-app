      ...
      >
        ...
        <View className="flex-col md:flex-row-reverse justify-between items-start md:items-end gap-4">
          <View className="items-end">
            <Text className="text-[32px] font-bold text-[#ffeba7] text-right">
              {"\u0625\u062f\u0627\u0631\u0629 \u0627\u0644\u0645\u0648\u0638\u0641\u064a\u0646"}
            </Text>
            <Text className="text-base text-[#969081] mt-1 text-right">
              {
                "\u0639\u0631\u0636 \u0648\u0625\u062f\u0627\u0631\u0629 \u062d\u0633\u0627\u0628\u0627\u062a \u0627\u0644\u0645\u0648\u0638\u0641\u064a\u0646"
              }
            </Text>
          </View>
          <Pressable
          ...
          >
            ...
            <Text className="text-[#102770] font-semibold text-sm text-right">
              {"\u0625\u0636\u0627\u0641\u0629 \u0645\u0648\u0638\u0641"}
            </Text>
          </Pressable>
        </View>
          ...
          <View className="flex-col md:flex-row-reverse gap-4 w-full md:w-auto flex-1">
            ...
            <View className="w-full md:w-64">
              <View className="relative z-50" style={{ zIndex: 50, elevation: 10 }}>
                ...
                >
                  <Text className="text-[#e7e2da] text-right" numberOfLines={1}>
                    {departmentFilter}
                  </Text>
        ...
        {isLoading ? (
          ...
          <View className="flex-1 items-center justify-center py-20 mt-10">
            <Text className="text-[#969081] text-lg font-bold">
              {
          ...
          <View className="flex-col gap-2">
            <View className="hidden md:flex flex-row-reverse items-center gap-3 px-4 py-2">
              ...
              <Text className="flex-[2] text-[#969081] text-[11px] font-semibold text-right">
                {"\u0627\u0644\u0628\u0631\u064a\u062f \u0627\u0644\u0625\u0644\u0643\u062a\u0631\u0648\u0646\u064a"}
              </Text>
              <Text className="flex-1 text-[#969081] text-[11px] font-semibold text-center">{"\u0627\u0644\u062d\u0627\u0644\u0629"}</Text>
              <Text className="flex-[1.5] text-[#969081] text-[11px] font-semibold text-left">
                {"\u0627\u0644\u0625\u062c\u0631\u0627\u0621\u0627\u062a"}
              </Text>
            </View>
                ...
                >
                  <View className="w-full md:flex-[2] min-w-0 flex-row-reverse items-center gap-3">
                    ...
                    <View className="flex-col items-end flex-1 min-w-0">
                      <Text className="text-[#e7e2da] font-bold text-sm text-right" numberOfLines={1}>
                        {employee.name}
                      </Text>
                  ...
                  <View className="w-full md:flex-[1.5] min-w-0">
                    <Text className="text-[#e7e2da] text-sm text-right flex-shrink" numberOfLines={1}>
                      {employee.department}
                    </Text>
                  </View>

                  <View className="w-full md:flex-[2] min-w-0">
                    <Text className="text-[#969081] text-sm text-right flex-shrink" numberOfLines={1}>
                      {employee.email}
                    </Text>
                  </View>
                  ...
                  <View className="w-full md:flex-[1.5] flex-row-reverse md:flex-row gap-2 justify-end md:justify-start">
                    <Pressable className="border border-[#3e3f4b] py-2 px-3 rounded-[12px] flex-row-reverse items-center gap-1.5 bg-transparent hover:bg-[#1f2029] active:bg-[#1f2029] hover:border-[#ffeba7]/50 transition-colors cursor-pointer">
                      <Ionicons name="eye-outline" size={16} color="#e7e2da" />
                      <Text className="text-[#e7e2da] text-xs font-semibold">{"عرض التفاصيل"}</Text>
                    </Pressable>
                    <Pressable className="px-2.5 py-2 border border-[#3e3f4b] rounded-[12px] items-center justify-center bg-transparent hover:bg-[#1f2029] active:bg-[#1f2029] hover:border-[#ffeba7]/50 transition-colors cursor-pointer">
                ...
                >
                  ...
                  <View className="flex-row-reverse items-center gap-4 justify-end mt-2">
                    ...
                    <View className="flex-col items-end flex-1">
                      <Text className="text-[18px] font-bold text-[#e7e2da] text-right" numberOfLines={1}>
                        {employee.name}
                      </Text>
                  ...
                  <View className="flex-col gap-3 mt-2 border-t border-[#ffeba7]/10 pt-4">
                    <View className="flex-row-reverse items-center gap-3 justify-start">
                      ...
                      <Text className="text-sm text-[#969081] text-right flex-1" numberOfLines={1}>
                        {employee.email}
                      </Text>
                    </View>
                    <View className="flex-row-reverse items-center gap-3 justify-start">
                  ...
                  <View className="flex-row-reverse gap-3 mt-auto pt-4 border-t border-[#ffeba7]/10">
                    <Pressable className="flex-1 bg-transparent border border-[#3e3f4b] py-2.5 rounded-[12px] flex-row-reverse items-center justify-center gap-2 hover:bg-[#1f2029] active:bg-[#1f2029] hover:border-[#ffeba7]/50 transition-colors cursor-pointer">
                      <Ionicons name="eye-outline" size={16} color="#e7e2da" />
                      <Text className="text-[#e7e2da] text-sm font-semibold">{"عرض التفاصيل"}</Text>
                    </Pressable>
                    <Pressable className="px-4 py-2.5 bg-transparent border border-[#3e3f4b] rounded-[12px] items-center justify-center hover:bg-[#1f2029] active:bg-[#1f2029] hover:border-[#ffeba7]/50 transition-colors cursor-pointer">
                      <Ionicons name="settings" size={18} color="#e7e2da" />
                    </Pressable>
                  </View>
                </Pressable>
